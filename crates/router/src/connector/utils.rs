    ...
    fn from(pm_data: domain::payments::PaymentMethodData) -> Self {
        match pm_data {
            ...
            domain::payments::PaymentMethodData::Wallet(wallet_data) => match wallet_data {
                ...
                domain::payments::WalletData::DjamoRedirect(_) => Self::DjamoRedirect,
                domain::payments::WalletData::TMoneyRedirect(_) => Self::TMoneyRedirect,
                domain::payments::WalletData::WizallRedirect(_) => Self::WizallRedirect,
                domain::payments::WalletData::ExpressoRedirect(_) => Self::ExpressoRedirect,
                domain::payments::WalletData::FreeMoneyRedirect(_) => Self::FreeMoneyRedirect,
                domain::payments::WalletData::WaveRedirect(_) => Self::WaveRedirect,
                domain::payments::WalletData::MoovMoneyRedirect(_) => Self::MoovMoneyRedirect,
